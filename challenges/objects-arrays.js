 ...
 * 
 * @param {Object} {name, diet, weight, length, period} 
 * @returns {Object} Animal
 */
function Animal({ name, diet, weight, length, period }) {
	this.name = name;
	this.diet = diet;
	this.weight = weight;
	this.length = length;
...
// Cycle over graduates array and get each graduate university
...
// Cycle over graduates array and get each graduate first name and email
const contactInfo = [];
...
// Cycle over graduates array and get each graduate that university has the word Uni
for (const graduate of graduates) {
...
// Cycle over zooAnimals array and get each animal name and scientific name
